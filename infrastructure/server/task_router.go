...
func (router *TaskRouter) ServeRoutes() {
	...
	router.router.GET("/last/:line_id/", router.middlewares.CORSMiddleware.AddCORSMiddleware(), router.middlewares.AuthMiddleware.ValidateAccessToken(), router.interfaceStore.TaskInterface.GetLast)
